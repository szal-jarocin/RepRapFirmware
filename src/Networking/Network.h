...
#elif defined(SAME70XPLD) || defined(DUET3_V05) || defined(DUET3_V06) || defined(DUET_NG) || defined(DUET_M) || defined(__LPC17xx__) || defined(STM32F4) || defined(PCCB) || defined(__RADDS__) || defined(DUET_5LC)
