...
constexpr PinEntry PinTable_Generic[] =
{
    ...
    {P0_6,  PinCapability::rwpwm, "0.6"},
    {P0_7,  PinCapability::rwpwm, "0.7"},
    {P0_8,  PinCapability::rwpwm, "0.8"},
    {P0_9,  PinCapability::rwpwm, "0.9"},
    {P0_10, PinCapability::rwpwm, "0.10"},
    {P0_11, PinCapability::rwpwm, "0.11"},
    {P0_12, PinCapability::rwpwm, "0.12"},
    {P0_13, PinCapability::rwpwm, "0.13"},
    {P0_14, PinCapability::rwpwm, "0.14"},
    ...
    {P0_29, PinCapability::rwpwm, "0.29"},
    {P0_30, PinCapability::ainrwpwm, "0.30"},
    {P0_31, PinCapability::ainrwpwm, "0.31"},
    {P1_0,  PinCapability::rwpwm, "1.0"},
    {P1_1,  PinCapability::rwpwm, "1.1"},
    {P1_2,  PinCapability::rwpwm, "1.2"},
    {P1_3,  PinCapability::rwpwm, "1.3"},
    {P1_4,  PinCapability::rwpwm, "1.4"},
    {P1_5,  PinCapability::rwpwm, "1.5"},
    {P1_6,  PinCapability::rwpwm, "1.6"},
    {P1_7,  PinCapability::rwpwm, "1.7"},
    {P1_8,  PinCapability::rwpwm, "1.8"},
    {P1_9,  PinCapability::rwpwm, "1.9"},
    {P1_10, PinCapability::rwpwm, "1.10"},
    {P1_11, PinCapability::rwpwm, "1.11"},
    {P1_12, PinCapability::rwpwm, "1.12"},
    {P1_13, PinCapability::rwpwm, "1.13"},
    {P1_14, PinCapability::rwpwm, "1.14"},
    {P1_15, PinCapability::rwpwm, "1.15"},
    {P1_16, PinCapability::rwpwm, "1.16"},
    {P1_17, PinCapability::rwpwm, "1.17"},
...
//NoPin for Generic, Must be specified in /sys/Board.txt 
